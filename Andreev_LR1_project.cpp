...
int main() {
    ...
    do {
        ...
        cout << "Выбор за Вами, Татьяна Викторовна: ";
        cin >> choice;
        ...
        switch (choice) {
            ...
            case 5:
                ...
                break;
            default:
                cout << "Неверный выбор. Будьте любезны повторить попытку.\n";
        }
    } while (choice != 5);
...
void inputThreeDigitNumber(int &X) {
    ...
    while (!(cin >> X) || X < 100 || X > 999) {
        cout << "Ошибка! Число должно быть трехзначным и никаким другим. Повторите попытку: ";
